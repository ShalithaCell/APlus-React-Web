...
const WeatherIcon = ({ classes, id }) => {
	switch (id) {
		case 0:
			return <Opacity className={ classes.rain } />;
		case 1:
			return <WbSunny className={ classes.sun } />;
		case 2:
			return <FilterDrama className={ classes.cloud } />;
		default:
			return null;
	}
};
