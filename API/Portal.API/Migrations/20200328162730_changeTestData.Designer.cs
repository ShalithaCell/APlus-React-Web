...
namespace Portal.API.Migrations
{
    ...
    [Migration("20200328162730_changeTestData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.API.Domain.DataBaseModels.CustomPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Permission = "Report",
                            PermissionCode = "RE",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 136, DateTimeKind.Local).AddTicks(1953)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Permission = "Sales",
                            PermissionCode = "SE",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6418)
                        },
                        new
                        {
                            ID = 3,
                            ...
                            PermissionCode = "IV",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6465)
                        },
                        new
                        {
                            ID = 4,
                            ...
                            PermissionCode = "IA",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6468)
                        },
                        new
                        {
                            ID = 5,
                            ...
                            PermissionCode = "IU",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6471)
                        },
                        new
                        {
                            ID = 6,
                            ...
                            PermissionCode = "ID",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6473)
                        },
                        new
                        {
                            ID = 7,
                            ...
                            PermissionCode = "CH",
                            RegistedDate = new DateTime(2020, 3, 28, 21, 57, 29, 138, DateTimeKind.Local).AddTicks(6474)
                        });
                });
            ...
            modelBuilder.Entity("Portal.API.Domain.DataBaseModels.TestData", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
