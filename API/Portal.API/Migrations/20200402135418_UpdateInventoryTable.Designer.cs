...
namespace Portal.API.Migrations
{
    ...
    [Migration("20200402135418_UpdateInventoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.API.Domain.DataBaseModels.CustomPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Permission = "Report",
                            PermissionCode = "RE",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 493, DateTimeKind.Local).AddTicks(3156)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            Permission = "Sales",
                            PermissionCode = "SE",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1141)
                        },
                        new
                        {
                            ID = 3,
                            ...
                            PermissionCode = "IV",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1164)
                        },
                        new
                        {
                            ID = 4,
                            ...
                            PermissionCode = "IA",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1166)
                        },
                        new
                        {
                            ID = 5,
                            ...
                            PermissionCode = "IU",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1168)
                        },
                        new
                        {
                            ID = 6,
                            ...
                            PermissionCode = "ID",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1169)
                        },
                        new
                        {
                            ID = 7,
                            ...
                            PermissionCode = "CH",
                            RegistedDate = new DateTime(2020, 4, 2, 19, 24, 18, 494, DateTimeKind.Local).AddTicks(1171)
                        });
                });
            ...
            modelBuilder.Entity("Portal.API.Domain.DataBaseModels.Inventory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
